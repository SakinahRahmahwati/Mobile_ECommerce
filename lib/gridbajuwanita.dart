...
class _GridBajuWanitaState extends State<GridBajuWanita> {
  ...
  Future<void> getElectronic() async {
    String urlElectronis =
        'http://10.0.3.2/backend_ecommerce/bajuwanitaCategory.php';
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => DetailBajuWanita(item: item)));
  }
...
class DetailBajuWanita extends StatelessWidget {
  final dynamic item;
  const DetailBajuWanita({Key? key, required this.item}) : super(key: key);
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => const GridBajuWanita()));
          },
        ),
        title: const Text(
          "Product Item",
