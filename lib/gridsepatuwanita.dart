...
class _GridSepatuWanitaState extends State<GridSepatuWanita> {
  ...
  Future<void> getElectronic() async {
    String urlElectronis =
        'http://10.0.3.2/backend_ecommerce/sepatuwanitaCategory.php';
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.of(context).pushReplacement(MaterialPageRoute(
                  builder: (BuildContext context) => const GridSepatuWanita()));
            },
            icon: const Icon(
              Icons.arrow_back,
              size: 20,
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              Padding(
                padding: const EdgeInsets.fromLTRB(30, 5, 170, 15),
                child: Text(
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(5, 5, 30, 15),
                child: Text(
