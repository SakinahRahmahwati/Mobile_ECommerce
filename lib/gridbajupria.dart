...
class _GridBajuPriaState extends State<GridBajuPria> {
  ...
  Future<void> getElectronic() async {
    String urlElectronis =
        'http://10.0.3.2/backend_ecommerce/bajupriaCategory.php';
  ...
  void onItemTap(int index) {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => DetailBajuPria(item: item)));
  }
...
class DetailBajuPria extends StatelessWidget {
  final dynamic item;
  const DetailBajuPria({Key? key, required this.item}) : super(key: key);
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) => const GridBajuPria()));
          },
        ),
        title: const Text(
          "Product Item",
